...
<head>
    <meta charset="utf-8">
    <title>Dave's Blog | Edit Post</title>
    ...
    //check for any errors
        ...
        <form action="" method="post">
            ...
            <div class="form-group">
                ...
                <input id="postTitle" class="form-control" type="text" name="postTitle" value="<?php echo $row['postTitle']; ?>">
            </div>
            <div class="form-group">
                <label for="postDesc">Description</label>
                <textarea id="postDesc" class="form-control" name="postDesc" cols="10" rows="1" maxlength="20"><?php echo $row['postDesc']; ?></textarea>
            </div>
            <div class="form-group">
                <label for="postCont">Content</label>
                <textarea id="postCont" class="form-control" name="postCont" cols="60" rows="10"><?php echo $row['postCont']; ?></textarea></p>
            </div>
